...
function App() {
  return (
    <div className='relative min-h-screen w-full'>
      ...
      <div className='p-10 flex flex-col lg:flex lg:flex-col justify-center items-center gap-20' id='Projects'>
        
        <div className='bg-neutral-800 p-5 rounded-3xl w-full lg:w-3/4 lg:flex justify-center'>
          <img src='/Projects/Hypertext.png' alt='Hypertext Screenshot' className='lg:w-1/2 w-full h-auto outline-1 rounded-3xl object-contain'></img>
          <div className='p-5 rounded-3xl lg:w-3/4 lg:flex lg:flex-col w-full text-center gap-5'>
            <div className='flex flex-row w-full'>
              <h1 className='text-3xl lg:text-5xl font-semibold underline underline-offset-5 w-3/4'>Hypertext Project</h1>
              <a href='https://github.com/Luke-Godbold/HyperText.git' rel='noopener noreferrer' target="_blank" className='w-1/10'><img src="/Icons/github-icon.png" alt='github logo' className='w-full'  ></img></a>
            </div>
        ...
        <div className='bg-neutral-800 p-5 rounded-3xl w-full lg:w-3/4 lg:flex justify-center'>
          ...
          <div className='p-5 rounded-3xl lg:w-3/4 lg:flex lg:flex-col w-full text-center gap-5'>
            <div className='flex flex-row w-full'>
              ...
              <a href='https://github.com/Luke-Godbold/Database' rel='noopener noreferrer' target="_blank" className='w-1/10'><img src="/Icons/github-icon.png" alt='github logo' className='w-full'  ></img></a>
            </div>
